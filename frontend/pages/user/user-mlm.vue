                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-3">
                                <span id="passwordHelpInline" class="form-text">
                                    <button @click="removeUserSegment" class="btn_cart mt-2 d-none" style="visibility: unset;">Remove User Segment</button>
                                    <p v-if="modifiedURL" class="d-none">
                                        Modified URL: {{ modifiedURL }}
                                    </p>
                                    <button @click="copyToClipboard" class="btn_cart mt-2" style="visibility: unset;"><i class="fa-solid fa-copy"></i>Copy URL</button>
                                </span>
                            </div>
                        </div>
                        <hr />
