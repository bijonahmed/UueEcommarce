                    ...
                    <div class="col-md-8">
                                    ...
                                    <table class="table w-100" style="width: 100%; font-size: 12px;">
                                        ...
                                        <tbody>
                                            <tr v-for="item in cart" :key="item.product.id">
                                                ...
                                                <td><img :src="item.product.thumnail_img" class="img-thumbnail" style="width: 50px; height:10%;"></td>
                                                <td>{{ item.quantity }} x ${{ item.product.price }}</td>
                                                <td><button type="button" @click="removeFromCart(item.product)"><i class="fa-solid fa-trash-can"></i></button></td>
                                            </tr>
                        ...
                        <div class="delivery_addreess">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="group ">
                                        ...
                                        <span class="text-danger" v-if="errors.name"><small>{{ errors.name[0] }}</small></span>
                                ...
                                <div class="col-md-12">
                                    <div class="group ">
                                        ...
                                        <span class="text-danger" v-if="errors.address"><small>{{ errors.address[0] }}</small></span>
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Address</label>
                                ...
                                <div class="col-md-6">
                                    <div class="group ">
                                        ...
                                        <span class="text-danger" v-if="errors.country"><small>{{ errors.country[0] }}</small></span>
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Country</label>
                                ...
                                <div class="col-md-6">
                                    <div class="group ">
                                        ...
                                        <span class="text-danger" v-if="errors.city"><small>{{ errors.city[0] }}</small></span>
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>City</label>
                            ...
                            <div class="different-address-form-trigger">
                                <input type="checkbox" id="direrent-address-toggle" class="sn-checkbox" v-model="showDifferentAddress" @click="copybillingAddress">
                                ...
                                <div class="row" v-if="showDifferentAddress">
                                    ...
                                    <div class="col-md-12">
                                        <div class="group ">
                                            <input type="text" class="input" v-model="insertdata.shipper_phone_number" />
                                            <span class="highlight"></span>
                                            <span class="bar"></span>
                                            <label>Phone</label>
                        ...
                        <div class="cart_sidebar">
                            <div class="pirce_summary">
                                ...
                                <span v-if="cart.length > 0">
                                    <button type="submit" class="btn_cart text-center" style="visibility: unset; background-color: #900C3F; color: #fff; margin-top: 10px;">Place Order</button>
                                </span>
                                <span v-else>
