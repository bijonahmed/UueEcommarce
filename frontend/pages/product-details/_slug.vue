                                    ...
                                    <div class="pro_info">
                                        <div class="badgeses">
                                            <div>
                                                ...
                                                <span style="background-color: red;"><a href="affiliate.html"
                                                        style="color: #fff;">Click to Get Your affiliate link</a></span>
                                            </div>
                                        ...
                                        <div class="price_div">
                                            ...
                                            <h5 v-if="pro_row.discount_status == 2">${{ price = (pro_row.price - pro_row.discount) }}
                                                <p> <strike>${{ pro_row.price }} </strike></p>
                                                <p>${{ pro_row.discount }} Discount</p>
                                            </h5>
                                            <h5 v-if="pro_row.discount_status == 1">${{ price = pro_row.price - (pro_row.price * pro_row.discount / 100) }}
                                                <p> <strike>${{ pro_row.price }} </strike></p> <span>{{ pro_row.discount
                                                    }}%</span>
                                                <!-- <p>${{ pro_row.discount }} Discount</p> -->
                                            </h5>

                                            <p v-if="pro_row.stock_status == 1">2-3 Days</p>
                                            <p v-else-if="pro_row.stock_status == 2">in stock</p>
                                            <p v-else-if="pro_row.stock_status == 3">Out of stock</p>
                                            <p v-else-if="pro_row.stock_status == 4">Preorder</p>
                                            <p v-else>Other</p>
                                        </div>
                                        <div class="ratings_pro">
                                            <p>+shipping ($0.5 In Dhaka)</p>
                                            ...
                                            <button type="button" class="btn_cart" style="visibility: unset;"
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div>
                                                ...
                                                <p>Ready for delivery between 18 August & 22 August when you order
                                                    within next 6hrs 1mins</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div>
                                ...
                                <div class="side_title">
                                    ...
                                    <div class="info_modal">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div><i class="fa-solid fa-x" type="button" style="cursor: pointer;"
                                                    id="modal_close"></i></div>
                                        </div>
                                        <div>
                                            <p>To help you decide on the best offer we have several key metrics to help
