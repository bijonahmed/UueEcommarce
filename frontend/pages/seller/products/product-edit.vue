                                                        ...
                                                        <div class="tab-pane fade" id="primary-pills-profile" role="tabpanel">
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <hr />
                                                                    <div class="row mb-3 required">
                                                                        <label for="input-meta-title-1" class="col-sm-4 col-form-label">Product Status</label>
                                                                        <div class="col-sm-4">
                                                                            <select class="form-select" aria-label=".form-select-sm example" v-model="insertdata.status">
                                                                                <option selected>Select</option>
                                                                                <option value="1">Yes</option>
                                                                                <option value="0">No</option>
                                                                            </select>
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <ul>
                                                                                    <li v-for="(item, index) in showProCategories" :key="index">
                                                                                        <span v-html="item">{{ item }}</span> <button type="button" @click="removeCategory(item)"><i class="fa-solid fa-circle-minus"></i></button>
                                                                                    </li>
                                                                                </ul>
