exports.ids = [115,15,16,17,19,23,25,26,46];
exports.modules = {
...
module.exports.__inject__ = function (context) {
  add("5bd8bf32", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_user_orders_vue_vue_type_style_index_0_id_30aee9d1_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(110);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_user_orders_vue_vue_type_style_index_0_id_30aee9d1_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_user_orders_vue_vue_type_style_index_0_id_30aee9d1_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_user_orders_vue_vue_type_style_index_0_id_30aee9d1_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_user_orders_vue_vue_type_style_index_0_id_30aee9d1_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".loading-indicator[data-v-30aee9d1]{background-color:hsla(0,0%,100%,.8);height:100%;left:0;position:fixed;top:0;width:100%;z-index:9999}.loader-container[data-v-30aee9d1],.loading-indicator[data-v-30aee9d1]{align-items:center;display:flex;justify-content:center}.loader-container[data-v-30aee9d1]{flex-direction:column;height:100vh;position:relative}.loader-text[data-v-30aee9d1]{margin:0}.loader-top[data-v-30aee9d1]{top:0}.loader-bottom[data-v-30aee9d1]{bottom:0}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user/user-orders.vue?vue&type=template&id=30aee9d1&scoped=true&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('LogoAndPayment'), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"search_bar\" data-v-30aee9d1>", "</section>", [_vm._ssrNode("<div class=\"container\" data-v-30aee9d1>", "</div>", [_vm._ssrNode("<div class=\"row justify-content-between align-items-center\" data-v-30aee9d1>", "</div>", [_vm._ssrNode("<div class=\"col-lg-3 col-md-4 col-4\" data-v-30aee9d1>", "</div>", [_vm._ssrNode("<div class=\"logo nav_tab\" data-v-30aee9d1>", "</div>", [_vm._ssrNode("<button type=\"button\" data-bs-toggle=\"offcanvas\" data-bs-target=\"#offcanvasExample\" aria-controls=\"offcanvasExample\" class=\"btn_menu mobile_view\" data-v-30aee9d1><i class=\"fa-solid fa-bars-staggered\" data-v-30aee9d1></i></button> "), _vm._ssrNode("<div tabindex=\"-1\" id=\"offcanvasExample\" aria-labelledby=\"offcanvasExampleLabel\" class=\"offcanvas offcanvas-start\" data-v-30aee9d1>", "</div>", [_vm._ssrNode("<div class=\"offcanvas-header\" data-v-30aee9d1><button type=\"button\" data-bs-dismiss=\"offcanvas\" aria-label=\"Close\" class=\"btn-close\" data-v-30aee9d1></button> <h5 id=\"offcanvasExampleLabel\" class=\"offcanvas-title\" data-v-30aee9d1>Ecommerce</h5></div> "), _vm._ssrNode("<div class=\"offcanvas-body\" data-v-30aee9d1>", "</div>", [_c('Common_MobileSidebar')], 1)], 2), _vm._ssrNode(" "), _c('Common_MiniTabNavbar'), _vm._ssrNode(" "), _c('Nuxt-link', {
    attrs: {
      "to": "/"
    }
  }, [_vm._v("Ecommerce "), _c('i', {
    staticClass: "fa-regular fa-star"
  })])], 2)]), _vm._ssrNode(" <div class=\"col-6 desktop_view mini_tab_hide\" data-v-30aee9d1><form action data-v-30aee9d1><i class=\"fa-solid fa-magnifying-glass\" data-v-30aee9d1></i> <input type=\"text\" name id placeholder=\"Search Product\" class=\"form-control\" data-v-30aee9d1> <button type=\"button\" data-v-30aee9d1>Search</button></form></div> "), _c('DesktopViewOption'), _vm._ssrNode(" <div class=\"col-4 ms-auto mobile_view\" data-v-30aee9d1><div class=\"mobile_nav_option\" data-v-30aee9d1><a class=\"search_form\" data-v-30aee9d1><i class=\"fa-solid fa-magnifying-glass\" data-v-30aee9d1></i></a></div></div> "), _c('Common_MobileSearchProduct')], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"main_content\" data-v-30aee9d1>", "</section>", [_vm._ssrNode("<div class=\"container-fluid\" data-v-30aee9d1>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-30aee9d1>", "</div>", [_vm._ssrNode("<div class=\"col-md-3\" data-v-30aee9d1>", "</div>", [_c('userSidebar')], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-md-9 ps-md-0\" data-v-30aee9d1>", "</div>", [_vm.loading ? _vm._ssrNode("<div class=\"loading-indicator\" data-v-30aee9d1>", "</div>", [_vm._ssrNode("<div class=\"loader-container\" data-v-30aee9d1>", "</div>", [_c('center', {
    staticClass: "loader-text"
  }, [_vm._v("Loading...")]), _vm._ssrNode(" <img src=\"/loader/loader.gif\" alt=\"Loader\" data-v-30aee9d1>")], 2)]) : _vm._e(), _vm._ssrNode(" <div class=\"main_profile\" data-v-30aee9d1><div class=\"recent_orders\" data-v-30aee9d1><h4 data-v-30aee9d1>Orders </h4> <table class=\"table\" data-v-30aee9d1><thead data-v-30aee9d1><tr data-v-30aee9d1><th data-v-30aee9d1>Order ID</th> <th data-v-30aee9d1>Place On </th> <th data-v-30aee9d1>Total </th> <th data-v-30aee9d1>Status </th> <th data-v-30aee9d1></th></tr></thead> <tbody data-v-30aee9d1>" + _vm._ssrList(_vm.orders, function (order) {
    return "<tr data-v-30aee9d1><td data-v-30aee9d1>" + _vm._ssrEscape(_vm._s(order.orderId)) + "</td> <td data-v-30aee9d1>" + _vm._ssrEscape(_vm._s(order.placeOn)) + "</td> <td data-v-30aee9d1>" + _vm._ssrEscape(_vm._s(order.total)) + "</td> <td data-v-30aee9d1>" + _vm._ssrEscape(_vm._s(order.name)) + "</td> <td data-v-30aee9d1><button class=\"btn btn_edit_nxt\" data-v-30aee9d1><i class=\"fas fa-search-plus\" data-v-30aee9d1></i></button></td></tr>";
  }) + "</tbody></table> <div class=\"row d-none\" data-v-30aee9d1><div class=\"col-12\" data-v-30aee9d1><div class=\"pagination\" data-v-30aee9d1><ul data-v-30aee9d1><li data-v-30aee9d1><a href=\"#\" data-v-30aee9d1> prv </a></li> <li data-v-30aee9d1><a href=\"#\" class=\"active\" data-v-30aee9d1> 1 </a></li> <li data-v-30aee9d1><a href=\"#\" data-v-30aee9d1> 2 </a></li> <li data-v-30aee9d1><a href=\"#\" data-v-30aee9d1> 3 </a></li> <li data-v-30aee9d1><a href=\"#\" data-v-30aee9d1> next </a></li></ul></div></div></div></div></div>")], 2)], 2)])]), _vm._ssrNode(" <div class=\"back_top\" data-v-30aee9d1><a href=\"#top\" data-v-30aee9d1><i class=\"fa-solid fa-angle-up\" data-v-30aee9d1></i></a></div> "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/user/user-orders.vue?vue&type=template&id=30aee9d1&scoped=true&
