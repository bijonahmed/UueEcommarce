    ...
    <div class="sidebar-wrapper" data-simplebar="true" style="background-color: black;">
        ...
        <ul class="metismenu" id="menu-collapse" is-nav>
            ...
            <span v-if="user.role_id === 1">
                <li>
                    <a href="#" class="has-arrow nav-link dropdown-toggle" id="submenuDropdown_30" role="button"
                    ...
                    <ul class="menu dropdown-menu" aria-labelledby="submenuDropdown_30" style="width:100%;">
                        <li>
                            <Nuxt-link to="/ecommarce/product-list"><i
                                    class="bx bx-right-arrow-alt"></i>Product</Nuxt-link>
                        </li>
                        <li>
                ...
                <li>
                    <a href="#" class="has-arrow nav-link dropdown-toggle" id="submenuDropdown_31" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bx bx-category"></i>
                ...
                <li>
                    <a href="#" class="has-arrow nav-link dropdown-toggle" id="submenuDropdown_15" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bx bx-category"></i>
                    ...
                    <ul class="menu dropdown-menu" aria-labelledby="submenuDropdown_15" style="width:100%;">
                        ...
                        <li>
                            <Nuxt-link to="/leave/leave-request-list"><i class="bx bx-right-arrow-alt"></i>Leave Request
                            </Nuxt-link>
                        </li>
                    </ul>
                </li>
